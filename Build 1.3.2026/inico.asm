...
.mode_found:
    ...
    mov [BI_BASE + 0x0C], ax
    mov ax, [BootDrive]
    mov [BI_BASE + 0x0E], ax           ; drive de boot do kernel (+0x0E)
    mov ax, [BlkSize]
    mov [BI_BASE + 0x10], ax           ; bytes/setor: 512 ou 2048 (+0x10)
    ...
    ; [BlkSize] so e conhecido apos o find_file (int 13h AH=48):
    ; re-grava no BootInfo p/ o kernel
    mov ax, [BlkSize]
    mov [BI_BASE + 0x10], ax
